...
class profileController extends Controller
{
    ...
    function update(Request $request){
        $request->validate([
            ...
            '_foto.mimes'=>"Images is only allowed in jpeg, jpg, png, or gif extension",
            '_email.mimes'=>"Email is required", 
            '_email.email'=>"Email is not valid" 
        ]);
        ...
        return redirect()->route('profile.index')->with('success', 'Update Data succesfully');
